# Kinship filtering in offspring in snp018a
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 313 excluded, 4869 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 4869 remaining.
