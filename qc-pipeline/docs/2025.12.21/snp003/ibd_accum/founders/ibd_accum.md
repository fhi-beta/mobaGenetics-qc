# Kinship filtering in founders in snp003
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 21 excluded, 8060 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 8060 remaining.
