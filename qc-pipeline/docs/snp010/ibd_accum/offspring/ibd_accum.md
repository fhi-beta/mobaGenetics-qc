# Kinship filtering in offspring in snp010
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 1938 excluded, 6830 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 6830 remaining.
