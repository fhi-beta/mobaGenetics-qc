# Kinship filtering in founders in snp018b
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 436 excluded, 2122 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 2122 remaining.
