# Kinship filtering in offspring in snp018b
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 9 excluded, 411 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 411 remaining.
