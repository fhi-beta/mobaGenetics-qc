# Kinship filtering in offspring in snp016b
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 2902 excluded, 20822 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 20822 remaining.
