# Kinship filtering in offspring in snp017d
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 421 excluded, 4944 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 4944 remaining.
