# Kinship filtering in offspring in snp018c
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 313 excluded, 5044 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 2 excluded, 5042 remaining.
