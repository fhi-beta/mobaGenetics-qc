...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 0 excluded, 4106 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 1 excluded, 4105 remaining.
