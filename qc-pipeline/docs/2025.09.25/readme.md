## Moba genotypes QC
Documentation of the quality control of the genotypes from the [Norwegian Mother, Father and Child Cohort Study (MoBa)](https://www.fhi.no/en/studies/moba/), release 2025.09.25. This is an interim release based on [release 2025.01.30](../2025.01.30/readme.md) where post-imputation modules were rerun after adjusting filters, pre-imputation results are identical.

### Test GWAS
- [Test GWAS](../../../gwas/docs/2025.09.25/readme.md): Results of a test GWAS conducted on this release.
...
- [Phasing](phasing_report.md): Currently, phasing is conducted per batch. This file provides information on within and across-batch phasing quality.
...
- [Admixture](snp009/pca_1kg_moba.md): Summary statistics on population clustering after running a principal component analysis on the genotypes merged with the 1,000 genomes. This was conducted using a set of approximately 500,000 high quality genotyped or imputedence autosome markers pruned for LD.
#### snp010
...
- [Admixture](snp018c/pca_1kg_moba.md): Summary statistics on population clustering after running a principal component analysis on the genotypes merged with the 1,000 genomes. This was conducted using a set of approximately 500,000 high quality genotyped or imputedence autosome markers pruned for LD.
#### snp018de
