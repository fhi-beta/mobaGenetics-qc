# Kinship filtering in founders in snp001
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 48 excluded, 12379 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 1 excluded, 12378 remaining.
