# Kinship filtering in founders in snp009
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 42 excluded, 11401 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 11401 remaining.
