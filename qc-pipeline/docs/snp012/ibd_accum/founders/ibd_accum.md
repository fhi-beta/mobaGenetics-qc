# Kinship filtering in founders in snp012
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 5727 excluded, 11273 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 11273 remaining.
