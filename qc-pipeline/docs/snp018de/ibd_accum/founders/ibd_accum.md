# Kinship filtering in founders in snp018de
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 40 excluded, 2039 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 2039 remaining.
