# Kinship filtering in offspring in snp015b
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 478 excluded, 3765 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 3765 remaining.
