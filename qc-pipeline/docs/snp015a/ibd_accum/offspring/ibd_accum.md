# Kinship filtering in offspring in snp015a
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 3213 excluded, 9681 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 9681 remaining.
