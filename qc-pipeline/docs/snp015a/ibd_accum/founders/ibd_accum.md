# Kinship filtering in founders in snp015a
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 1480 excluded, 6772 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 6772 remaining.
