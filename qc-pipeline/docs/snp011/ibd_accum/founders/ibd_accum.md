...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 3 excluded, 3079 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 3 excluded, 3076 remaining.
