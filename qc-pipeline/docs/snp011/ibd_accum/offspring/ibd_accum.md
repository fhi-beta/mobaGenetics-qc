# Kinship filtering in offspring in snp011
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 1353 excluded, 3696 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 3696 remaining.
