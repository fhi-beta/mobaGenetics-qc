# Kinship filtering in offspring in snp017c
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 237 excluded, 4336 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 1 excluded, 4335 remaining.
