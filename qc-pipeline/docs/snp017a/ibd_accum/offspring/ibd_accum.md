# Kinship filtering in offspring in snp017a
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 3147 excluded, 20823 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 20823 remaining.
