# Kinship filtering in offspring in snp014
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 1521 excluded, 3920 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 3920 remaining.
