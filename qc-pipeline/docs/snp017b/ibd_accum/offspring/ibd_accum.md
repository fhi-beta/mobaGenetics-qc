# Kinship filtering in offspring in snp017b
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 232 excluded, 4271 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 4271 remaining.
