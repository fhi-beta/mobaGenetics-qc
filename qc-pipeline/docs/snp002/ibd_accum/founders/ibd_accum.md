# Kinship filtering in founders in snp002
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 4 excluded, 1353 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 1 excluded, 1352 remaining.
