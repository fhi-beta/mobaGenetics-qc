# Kinship filtering in founders in snp018d
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 34 excluded, 1821 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 1821 remaining.
