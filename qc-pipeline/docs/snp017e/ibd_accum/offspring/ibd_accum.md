# Kinship filtering in offspring in snp017e
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 266 excluded, 4148 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 4148 remaining.
