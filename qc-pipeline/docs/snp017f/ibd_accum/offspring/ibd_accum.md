# Kinship filtering in offspring in snp017f
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 226 excluded, 4754 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 4754 remaining.
