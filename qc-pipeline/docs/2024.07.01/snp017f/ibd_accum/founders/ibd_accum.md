...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 18 excluded, 4785 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 1 excluded, 4784 remaining.
