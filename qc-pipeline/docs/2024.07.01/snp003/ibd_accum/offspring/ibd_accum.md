# Kinship filtering in offspring in snp003
...
Percolation of the relatedness graph using a Kinship threshold of 0.1: 16 excluded, 7728 remaining.
...
Removal of samples with accumulated kinship using threshold of 0.015: 0 excluded, 7728 remaining.
