...
for batch in batches:
    mismatch_information_path = os.path.join('/mnt/work/qc_genotypes/pipeOut_dev/2025.01.30/mod2-genetic-relationship', batch, "mismatch_information.gz")
    ...
    mismatch_relationship_path = os.path.join('/mnt/work/qc_genotypes/pipeOut_dev/2025.01.30/mod2-genetic-relationship', batch, "mismatch_relationship.gz")
