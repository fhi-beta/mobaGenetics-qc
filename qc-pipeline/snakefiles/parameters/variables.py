...
release_folder = Path(config['release_base']) / config['release']
release_base_name = "moba_genotypes_" + config['release']
...
batches_debug =  config['batches_debug']
chrs_debug = config['chrs_debug']
