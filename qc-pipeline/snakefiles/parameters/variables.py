...
tmpMod6_phasing_test = Path("/mnt/archive3/phasing_test/phase_confirmed_filtered_relationships_chr20")
...
phasing_batches = {}
for chr in chrs:
    phasing_batches[f"chr{chr}"] = [f"batch{i}" for i in range(n_phasing_batches[f"chr{chr}"])]
