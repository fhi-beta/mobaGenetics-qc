...
plink2local = Path(os.path.dirname(workflow.basedir))/'bin'/'plink-1.90b5.4'/'plink2'
...
batches = ['snp011', 'snp012', 'snp014', 'snp015b'] # Checked mod4
# Notes: snp015a fails sex chromosomes
...
# roles = ["offspring"] # Debug module 4
